-- ============================================================================
-- RESET SCRIPT: Drop all tables and recreate from scratch
-- ============================================================================
...
DROP TABLE IF EXISTS exercise_cards CASCADE;
...
CREATE INDEX idx_workout_exercises_exercise_card_id ON workout_exercises(exercise_card_id);
CREATE INDEX idx_workout_sessions_workout_id ON workout_sessions(workout_id);
CREATE INDEX idx_workout_sessions_athlete_id ON workout_sessions(athlete_id);
